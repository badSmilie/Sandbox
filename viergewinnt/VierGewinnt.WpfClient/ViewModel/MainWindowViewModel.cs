...
{
    public class MainWindowViewModel : IMainViewModel, INotifyPropertyChanged
    {
        ...
        public MainWindowViewModel(IReadOnlyList<ISpielerViewModel> pSpielerViewModels, ISpielbrettViewModel pSpielbrettViewModel, Spielbrett pSpielbrett)
        {
